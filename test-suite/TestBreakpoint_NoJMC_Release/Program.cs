...
namespace TestBreakpoint_NoJMC_Release
{
class Program
{
    ...
    {Console.WriteLine("BREAK_ATTR1");                          Label.Breakpoint("BREAK_ATTR1");
    ...
    {Console.WriteLine("BREAK_ATTR2");                          Label.Breakpoint("BREAK_ATTR2");
    ...
    {Console.WriteLine("BREAK_ATTR3");                          Label.Breakpoint("BREAK_ATTR3");
    }
}
...
class ctest_attr1
{
    ...
    {Console.WriteLine("BREAK_ATTR4");                          Label.Breakpoint("BREAK_ATTR4");
...
{
    public static void test_func()
    {Console.WriteLine("BREAK_ATTR5");                          Label.Breakpoint("BREAK_ATTR5");
