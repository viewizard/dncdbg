...
namespace DAPTestEvalArraysIndexers
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Label.Checkpoint("bp_test", "finish", (Object context) => {
                ...
                // check List<MyString>
                Context.GetAndCheckValue(@"__FILE__ :__LINE__", frameId, "{DAPTestEvalArraysIndexers.MyString}", "DAPTestEvalArraysIndexers.MyString", "listms[3]");
                Context.GetAndCheckValue(@"__FILE__ :__LINE__", frameId, "{DAPTestEvalArraysIndexers.MyString}", "DAPTestEvalArraysIndexers.MyString", "listms[ 3]");
                Context.GetAndCheckValue(@"__FILE__ :__LINE__", frameId, "{DAPTestEvalArraysIndexers.MyString}", "DAPTestEvalArraysIndexers.MyString", "listms[3 ]");
                Context.GetAndCheckValue(@"__FILE__ :__LINE__", frameId, "{DAPTestEvalArraysIndexers.MyString}", "DAPTestEvalArraysIndexers.MyString", "listms[ 3 ]");
                ...
                // check nullables
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "DAPTestEvalArraysIndexers.SimpleInt", "sinull");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{System.NullReferenceException}", "System.NullReferenceException", "sinull[0]");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "DAPTestEvalArraysIndexers.SimpleInt", "sinull?[0]");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "DAPTestEvalArraysIndexers.SimpleInt", "siq");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{System.NullReferenceException}", "System.NullReferenceException", "siq[0]");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "DAPTestEvalArraysIndexers.SimpleInt", "siq?[0]");
