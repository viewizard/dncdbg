...
class Program
{
    static void Main(string[] args)
    {
        ...
        Label.Checkpoint("test_attr2", "test_property_attr1",
            (Object context) =>
            {
                Context Context = (Context)context;
        ...
        Label.Checkpoint("test_property_attr1", "test_step_through",
            (Object context) =>
            {
                Context Context = (Context)context;
    ...
    {                                                       Label.Breakpoint("inside_func1_1");
        ...
        Label.Checkpoint("step_out_func", "step_over",
            (Object context) =>
            {
                Context Context = (Context)context;
    ...
    static public void test_func2()
    {
        ...
        Label.Checkpoint("step_over_breakpoint", "test_attr1",
            (Object context) =>
            {
                Context Context = (Context)context;
