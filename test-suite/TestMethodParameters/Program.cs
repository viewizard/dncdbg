    ...
    static void Main(string[] args)
    {
        ...
        Label.Checkpoint("test_static", "test_instance",
            (Object context) =>
            {
                ...
                Context.TestStackTrace(@"__FILE__:__LINE__", "TestMethodParameters.Program.Bcd(string s2, int i2, uint u2)", stacktrace, 2);
                Context.Continue(@"__FILE__:__LINE__");
            });
        ...
        Label.Checkpoint("test_instance", "finish",
            (Object context) =>
            {
                ...
                Context.TestStackTrace(@"__FILE__:__LINE__", "TestMethodParameters.TestClass.Abc(int i1, string s1, uint u1)", stacktrace, 2);
