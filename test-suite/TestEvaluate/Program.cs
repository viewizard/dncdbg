    ...
    public void func(int arg_test)
    {
        ...
        Label.Checkpoint("this_test", "nested_test",
            (Object context) =>
            {
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.test_this_t}", "TestEvaluate.test_this_t", "this");
                ...
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.test_this_t.this_i", "error:"); // error, cannot be accessed in this way
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.test_this_t.this_static_str", "error:"); // error, cannot be accessed in this way
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "3", "int", "TestEvaluate.test_this_t.this_static_i");
            ...
            public void func()
            {
                ...
                Label.Checkpoint("nested_test", "base_class_test",
                    (Object context) =>
                    {
                        ...
                        Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "5", "int", "TestEvaluate.test_static_class1_t.static_field_i1");
                        Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "4", "int", "TestEvaluate.test_static_struct1_t.static_field_i1");
                        Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "53", "int", "TestEvaluate.test_nested.nested_static_i");
                        Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "253", "int", "TestEvaluate.test_nested.test_nested_1.test_nested_2.nested_static_i");
                        Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "353", "int", "TestEvaluate.test_nested.test_nested_1.test_nested_3.nested_static_i");
    ...
    static void Main(string[] args)
    {
        ...
        Label.Checkpoint("values_test", "expression_test",
            (Object context) =>
            {
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.test_array[4]}", "TestEvaluate.test_array[]", "array2");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.test_array}", "TestEvaluate.test_array", "array2[0]");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.test_array}", "TestEvaluate.test_array", "array2[2]");
        ...
        Label.Checkpoint("static_test", "this_test",
            (Object context) =>
            {
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "5", "int", "TestEvaluate.test_static_class1_t.static_field_i1");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "5", "int", "test_static_class1_t.static_field_i1");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "5", "int", "TestEvaluate . test_static_class1_t  .  static_field_i1  "); // check spaces
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "7", "int", "TestEvaluate.test_static_class1_t.static_property_i2");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "7", "int", "test_static_class1_t.static_property_i2");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "4", "int", "TestEvaluate.test_static_struct1_t.static_field_i1");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "3", "float", "TestEvaluate.test_static_struct1_t.static_field_f1");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "6", "int", "TestEvaluate.test_static_struct1_t.static_property_i2");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "6", "int", "test_static_struct1_t.static_property_i2");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "8", "int", "TestEvaluate.test_static_class1_t.st.field_i1");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "7.1", "double", "TestEvaluate.test_static_class1_t.cl.field_d1");
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.test_static_class1_t.not_declared", "error:"); // error, no such field in class
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.test_static_struct1_t.not_declared", "error:"); // error, no such field in struct
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.test_static_class1_t.st.not_declared", "error:"); // error, no such field in struct
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.test_static_class1_t.cl.not_declared", "error:"); // error, no such field in class
        ...
        Label.Checkpoint("base_class_test", "override_test",
            (Object context) =>
            {
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "401", "int", "TestEvaluate.test_static_child.static_i_f_child");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "402", "int", "TestEvaluate.test_static_child.static_i_p_child");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "301", "int", "TestEvaluate.test_static_child.static_i_f_parent");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "302", "int", "TestEvaluate.test_static_child.static_i_p_parent");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "55", "int", "TestEvaluate.Program.test_nested_static_instance.nested_i");
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.test_static_child", "error:");
        ...
        Label.Checkpoint("literals_test", "conditional_access_test",
            (Object context) =>
            {
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "int[]", "literal1_array");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.TestClass[]", "literal1_array_testclass");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "int[,,]", "literal1_array2");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "System.Random[,,]", "literal1_array2_random");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.TestClass[,,]", "literal1_array2_testclass");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "int[]", "literal3_array");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.TestClass[]", "literal3_array_testclass");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "int[,,]", "literal3_array2");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "System.Random[,,]", "literal3_array2_random");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.TestClass[,,]", "literal3_array2_testclass");
        ...
        Label.Checkpoint("conditional_access_test", "method_calls_test",
            (Object context) =>
            {
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.test_child", "child_null?.i_child");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.test_child", "child_null?.i_parent");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "402", "int", "child?.i_child");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "302", "int", "child?.i_parent");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.conditional_access1}", "TestEvaluate.conditional_access1", "conditional_access?.member");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "555", "int", "conditional_access?.member.i");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.conditional_access2", "conditional_access_null?.member");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.conditional_access2", "conditional_access_null?.member.i");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.conditional_access1", "conditional_access_double_null?.member?.i");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.conditional_access2[]", "conditional_array_null?[0]");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.conditional_access2[]", "conditional_array_null?[0].member");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.conditional_access2[]", "conditional_array_null?[0].member.i");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.conditional_access2}", "TestEvaluate.conditional_access2", "conditional_array?[0]");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.conditional_access1}", "TestEvaluate.conditional_access1", "conditional_array?[0].member");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "555", "int", "conditional_array?[0].member.i");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.object_with_array", "object_with_array_null?.array[1]");
        ...
        Label.Checkpoint("method_calls_test", "unary_operators_test",
            (Object context) =>
            {
                ...
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "MethodCallTest?.Calc1()", "error:");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "6", "int", "MethodCallTest?.Calc2()");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "\"TestEvaluate.MethodCallTest1\"", "string", "MethodCallTest?.ToString()");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.MethodCallTest1", "methodCallTest1Null?.Calc2()");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.MethodCallTest2", "methodCallTest2Null?.member.Calc2()");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.MethodCallTest1", "methodCallTest2.nullMember?.Calc2()");

                // Call non static method in static member.
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "6", "int", "TestEvaluate.MethodCallTest2.member1.Calc2()");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "6", "int", "MethodCallTest2.member1.Calc2()");
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.MethodCallTest2.member1.Calc1()", "error:");
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "MethodCallTest2.member1.Calc1()", "error:");

                // Call static method.
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "5", "int", "TestEvaluate.MethodCallTest1.Calc1()");
                Context.CheckErrorAtRequest(@"__FILE__:__LINE__", frameId, "TestEvaluate.MethodCallTest1.Calc2()", "error:");
        ...
        Label.Checkpoint("coalesce_test", "finish",
            (Object context) =>
            {
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.coalesce_test_A}", "TestEvaluate.coalesce_test_A", "A_class??test_null");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.coalesce_test_A}", "TestEvaluate.coalesce_test_A", "test_null??A_class");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.coalesce_test_A", "test_null??test_null");

                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.coalesce_test_A}", "TestEvaluate.coalesce_test_A", "test_null??test_null??A_class");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.coalesce_test_A}", "TestEvaluate.coalesce_test_A", "A_class??test_null??test_null");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{TestEvaluate.coalesce_test_A}", "TestEvaluate.coalesce_test_A", "test_null??A_class??test_null");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "TestEvaluate.coalesce_test_A", "test_null??test_null??test_null");
