...
namespace TestEvalArraysIndexers
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Label.Checkpoint("bp_test", "finish", (Object context) => {
                ...
                // check List<MyString>
                Context.GetAndCheckValue(@"__FILE__ :__LINE__", frameId, "{TestEvalArraysIndexers.MyString}", "TestEvalArraysIndexers.MyString", "listms[3]");
                Context.GetAndCheckValue(@"__FILE__ :__LINE__", frameId, "{TestEvalArraysIndexers.MyString}", "TestEvalArraysIndexers.MyString", "listms[ 3]");
                Context.GetAndCheckValue(@"__FILE__ :__LINE__", frameId, "{TestEvalArraysIndexers.MyString}", "TestEvalArraysIndexers.MyString", "listms[3 ]");
                Context.GetAndCheckValue(@"__FILE__ :__LINE__", frameId, "{TestEvalArraysIndexers.MyString}", "TestEvalArraysIndexers.MyString", "listms[ 3 ]");
