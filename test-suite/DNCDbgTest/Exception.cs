...
{
    public ResultTrueException(object expected, object actual, string stacktrace) : base(expected, actual, stacktrace)
    {
    }
}
...
{
    public ResultFalseException(object expected, object actual, string stacktrace) : base(expected, actual, stacktrace)
    {
    }
}
