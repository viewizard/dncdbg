...
namespace NetcoreDbgTestCore
{
    public class GeneratedScript
    {
        ...
        foreach (string pathToFile in pathToFiles)
        {
            ...
            SyntaxTree testTree = CSharpSyntaxTree.ParseText(testSource).WithFilePath(pathToFile);
            trees.Add(testTree);
        }
    ...
    Compilation CompileTree(SyntaxTree tree)
    {
        ...
        var compilation = CSharpCompilation.Create("ControlScript", new SyntaxTree[] { tree }, GetMetadataReferences(),
...
public class TestLabelsInfoCollector : CSharpSyntaxWalker
{
    ...
    public override void VisitInvocationExpression(InvocationExpressionSyntax node)
    {
        ...
        case "Label.Checkpoint":
            ...
            TestLabelsInfo.CheckPointInvokes.Add(id, new Tuple<string, InvocationExpressionSyntax>(next_id, node));
            break;
        }
...
public class GeneratedScriptInvokesBuilder : CSharpSyntaxRewriter
{
    ...
    {
        var controlEnterMember = SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression,
        ...
        {
            var invokeEnter = SyntaxFactory.InvocationExpression(controlEnterMember).WithArgumentList(invoke.ArgumentList);
