...
namespace DAPTestSrcBreakpointResolve
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            Label.Checkpoint("init", "bp_test1", (Object context) => {
                ...
                Context.AddBreakpoint(@"__FILE__:__LINE__", "bp3", "DAPTestSrcBreakpointResolve/Program.cs");
                Context.AddBreakpoint(@"__FILE__:__LINE__", "bp4", "./DAPTestSrcBreakpointResolve/folder/../Program.cs");
...
Label.Breakpoint("resolved_bp2");       Console.WriteLine("Hello World!");
            ...
            Label.Checkpoint("bp_test2", "bp_test3", (Object context) => {
                ...
                if (isWindows)
                    Context.AddBreakpoint(@"__FILE__:__LINE__", "bp6", "./DAPTestSrcBreakpointResolve/PROGRAM.CS");
                else
                    Context.AddBreakpoint(@"__FILE__:__LINE__", "bp6", "./DAPTestSrcBreakpointResolve/Program.cs");
...
Label.Breakpoint("resolved_bp3");       Console.WriteLine(
            ...
            Label.Checkpoint("bp_test3", "bp_test4", (Object context) => {
                ...
                bool isWindows = System.Runtime.InteropServices.RuntimeInformation.IsOSPlatform(System.Runtime.InteropServices.OSPlatform.Windows);
                if (isWindows)
                    Context.RemoveBreakpoint(@"__FILE__:__LINE__", "bp6", "./DAPTestSrcBreakpointResolve/PROGRAM.CS");
                else
                    Context.RemoveBreakpoint(@"__FILE__:__LINE__", "bp6", "./DAPTestSrcBreakpointResolve/Program.cs");
                ...
                Context.AddBreakpoint(@"__FILE__:__LINE__", "bp8", "DAPTestSrcBreakpointResolve/Program.cs");
                Context.AddBreakpoint(@"__FILE__:__LINE__", "bp9", "./DAPTestSrcBreakpointResolve/folder/../Program.cs");
                Context.SetBreakpoints(@"__FILE__:__LINE__");
                int? current_bp_id =  Context.GetBreakpointId(@"__FILE__:__LINE__", "bp9", "./DAPTestSrcBreakpointResolve/folder/../Program.cs");
...
Label.Breakpoint("resolved_bp4");       Console.WriteLine(
            ...
            DAPTestSrcBreakpointResolve2.Program.testfunc();
