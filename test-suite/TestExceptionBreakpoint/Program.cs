...
class Program
{
    ...
    {
        Label.Checkpoint("init", "test_rethrow",
            (Object context) =>
            {
        ...
        Label.Checkpoint("test_rethrow", "test_all",
            (Object context) =>
            {
                Context Context = (Context)context;
        ...
        Label.Checkpoint("test_user_unhandled", "test_user_unhandled_empty_options",
            (Object context) =>
            {
                ...
                Context.Continue(@"__FILE__:__LINE__");
                Context.WasExceptionBreakpointHit(@"__FILE__:__LINE__", "bp3", "CLR", "userUnhandled",
                                                "System.Exception");
                Context.Continue(@"__FILE__:__LINE__");
        ...
        // test filter "user-unhandled" with options "!System.Exception" ("user-unhandled" for all except
        // "System.Exception")
