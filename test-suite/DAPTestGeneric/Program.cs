...
namespace NetcoreDbgTest.Script
{
    class Context
    {
        public void PrepareStart(string caller_trace)
        {
            ...
            Assert.True(DAPDebugger.Request(initializeRequest).Success,
                        @"__FILE__:__LINE__"+"\n"+caller_trace);
            ...
            Assert.True(DAPDebugger.Request(launchRequest).Success,
                        @"__FILE__:__LINE__"+"\n"+caller_trace);
        }
        ...
        public void PrepareEnd(string caller_trace)
        {
            ...
            Assert.True(DAPDebugger.Request(configurationDoneRequest).Success,
                        @"__FILE__:__LINE__"+"\n"+caller_trace);
        }
        ...
        public void WasEntryPointHit(string caller_trace)
        {
            ...
            Assert.True(DAPDebugger.IsEventReceived(filter),
                        @"__FILE__:__LINE__"+"\n"+caller_trace);
        }
        ...
        public void DebuggerExit(string caller_trace)
        {
            ...
            Assert.True(DAPDebugger.Request(disconnectRequest).Success,
                        @"__FILE__:__LINE__"+"\n"+caller_trace);
        }
        ...
        public void SetBreakpoints(string caller_trace)
        {
            ...
            Assert.True(DAPDebugger.Request(setBreakpointsRequest).Success,
                        @"__FILE__:__LINE__"+"\n"+caller_trace);
        }
        ...
        public void Continue(string caller_trace)
        {
            ...
            Assert.True(DAPDebugger.Request(continueRequest).Success,
                        @"__FILE__:__LINE__"+"\n"+caller_trace);
        }
    ...
    class Program
    {
        ...
        public class TestGeneric<T,U>
        {
            ...
            public void test_func()
            {
                ...
                Label.Checkpoint("test_func", "test_set_value", (Object context) => {
                    ...
                    Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{DAPTestGeneric.Program.TestGeneric<int, string>}", "DAPTestGeneric.Program.TestGeneric<int, string>", "this");
                    ...
                    Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{DAPTestGeneric.Program.MY}", "DAPTestGeneric.Program.MY", "test2<MY>(my)");
                    ...
                    Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{DAPTestGeneric.Program.MY}", "DAPTestGeneric.Program.MY", "static_test2<MY>(my)");
                    ...
                    Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "\"DAPTestGeneric.Program+CHILDOFMY`1[System.Int32]\"", "string", "ichofmy.ToString()");
                    ...
                    Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "\"DAPTestGeneric.Program+CHILDOFMY`1[System.String]\"", "string", "schofmy.ToString()");
        ...
        static void Main(string[] args)
        {
            ...
            Label.Checkpoint("test_main", "test_func", (Object context) => {
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{DAPTestGeneric.Program.TestGeneric<int, string>}", "DAPTestGeneric.Program.TestGeneric<int, string>", "ttt");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{DAPTestGeneric.Program.MY}", "DAPTestGeneric.Program.MY", "ttt.test2<MY>(my)");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "DAPTestGeneric.Program.TestNested<char, int>", "uninitialized?.uninitialized?.test3<string>('c',456,\"cde\")");
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "null", "DAPTestGeneric.Program.TestNested<char, int>.Nested<char, int>", "testnested.uninitialized?.test3<string>('c',456,\"cde\")");
                ...
                Context.GetAndCheckValue(@"__FILE__:__LINE__", frameId, "{DAPTestGeneric.Program.MY}", "DAPTestGeneric.Program.MY", "TestGeneric<int,string>.static_test2<MY>(my)");
