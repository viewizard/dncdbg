...
if(CMAKE_SYSTEM_NAME STREQUAL Linux)
    ...
    if(CLR_CROSS_COMPONENTS_BUILD)
        ...
        elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL loongarch64)
            set(CLR_CMAKE_PLATFORM_UNIX_LOONGARCH64 1)
        else()
            clr_unknown_arch()
        endif()
    endif()
...
elseif(CLR_CMAKE_PLATFORM_UNIX_LOONGARCH64)
    set(CLR_CMAKE_PLATFORM_ARCH_LOONGARCH64 1)
...
if(NOT(CLR_CMAKE_TARGET_ARCH STREQUAL CLR_CMAKE_HOST_ARCH))
    if(NOT((CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_ARM64) OR 
           (CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_ARM) OR
           (CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_RISCV64) OR
           (CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_I386) OR
           (CLR_CMAKE_PLATFORM_ARCH_I386 AND CLR_CMAKE_TARGET_ARCH_ARM)))
